...
console.log("Отсортированный массив скиллов", sortSkills);
...
console.log("Отсортированный по друзьям массив имён", sortName);
...
console.log("Не повто/ряющиеся друзья всех пользователей", noRepeatNameOfFriends);